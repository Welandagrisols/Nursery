...
const CACHE_NAME = 'graceharvestseedlings-v1'
const RUNTIME_CACHE = 'graceharvestseedlings-runtime'
...
self.addEventListener('push', event => {
  if (event.data) {
    ...
    event.waitUntil(
      self.registration.showNotification('Grace Harvest Seedlings', options)
    )
  }
})
